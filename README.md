...
## Problem definition
The client Mr. Figueroa is a student at UWC ISAK and he is a professional violinist. Therefore he is very worried about the effect of the humidity and temperature in ISAK on his precious violin. He is looking for a way to scale the humidity in his room with the most accurate yet affordable setup. He does not aim to look for a cheap alternative, he wants a proper sensor that could tell him the accurate temperature and humidity. The client also is willing to use python for easier control and he also hopes that Arduino could help him with the whole project since some other alternatives are expensive compared to Arduino.
